...
Everything except for X,Y,VX,VY is known, so we have a linear equation with 4 variables. We can solve this with Gaussian elimination using a couple of hailstones
